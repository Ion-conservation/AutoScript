...
fun TaskItemRow(
    ...
    val backgroundColor = when (task.importance) {
        TaskImportance.IMPORTANT -> Color(0xFF4D1A1A) // 更深的金属红背景
    ...
    Card(
        ...
        border = BorderStroke(
            1.dp,
            if (task.importance == TaskImportance.IMPORTANT) DashboardColors.Primary else DashboardColors.PrimaryVariant
        ),
        ...
        Row(
            ...
            Row(
                ...
                Text(
                    ...
                    fontSize = 16.sp,
                    color = if (task.importance == TaskImportance.IMPORTANT) DashboardColors.Primary else DashboardColors.Accent,
                ...
                Column {
                    ...
                    Text(
                        ...
                        fontSize = 11.sp,
                        color = DashboardColors.Secondary.copy(alpha = 0.7f)
                    )
                }
            }
            Row(
                ...
                IconButton(
                    ...
                    Icon(
                        ...
                        tint = if (task.isLocked) DashboardColors.Primary else DashboardColors.Accent
                    )
                }
                ...
                if (!task.isLocked) {
                    ...
                    IconButton(
                        ...
                        Icon(
                            ...
                            tint = DashboardColors.Secondary
                        )
                    }
