...
import auto.script.feature.beverage.db.dao.BeverageCatalogDao
import auto.script.feature.beverage.db.dao.BeverageDao
import auto.script.feature.beverage.db.entity.BeverageCatalogEntity
import auto.script.feature.beverage.db.entity.BeverageEntity
import auto.script.feature.scheduler.db.dao.TaskDao
import auto.script.feature.scheduler.db.entity.TaskEntity

@Database(entities = [TaskEntity::class, BeverageEntity::class, BeverageCatalogEntity::class], version = 6, exportSchema = false)
